...
urlpatterns = [
    ...
    path('booking/add-service-inline/<int:booking_id>/', views.booking_add_service_inline, name='booking_add_service_inline'),
    path('booking/remove-service-inline/<int:service_id>/', views.booking_remove_service_inline, name='booking_remove_service_inline'),
