...
urlpatterns = [
    ...
    path('boats/add/<int:customer_id>/', views.boat_create, name='boat_create'),
    ...
    path('booking/add-supply/<int:booking_id>/', views.booking_add_supply, name='booking_add_supply'),
    path('booking/remove-supply/<int:supply_id>/', views.booking_remove_supply, name='booking_remove_supply'),
    path('checkout/<int:berth_id>/', views.checkout_view, name='checkout'),
    path('reports/', views.reports_view, name='reports'),
    path('menu/preferences/', views.menu_preferences_modal, name='menu_preferences_modal'),
